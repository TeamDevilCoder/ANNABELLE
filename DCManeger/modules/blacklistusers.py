...
import DCManeger.modules.sql.blacklistusers_sql as sql
from DCManeger import DEMONS, DEV_USERS, DRAGONS, OWNER_ID, TIGERS, WOLVES, dispatcher
from DCManeger.modules.helper_funcs.chat_status import dev_plus
