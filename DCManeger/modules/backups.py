...
# from DCManeger.modules.sql import warns_sql as warnssql
import DCManeger.modules.sql.blacklist_sql as blacklistsql

# from DCManeger.modules.sql import cust_filters_sql as filtersql
# import DCManeger.modules.sql.welcome_sql as welcsql
import DCManeger.modules.sql.locks_sql as locksql
import DCManeger.modules.sql.notes_sql as sql

# from DCManeger.modules.rules import get_rules
import DCManeger.modules.sql.rules_sql as rulessql
from DCManeger import EVENT_LOGS,OWNER_ID, SUPPORT_CHAT, dispatcher
from DCManeger.__main__ import DATA_IMPORT
from DCManeger.modules.connection import connected
from DCManeger.modules.helper_funcs.alternate import typing_action
from DCManeger.modules.helper_funcs.chat_status import user_admin
from DCManeger.modules.sql import disable_sql as disabledsql
...
def export_data(update, context):
    ...
    with open("DCManeger{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("DCManeger{}.backup".format(chat_id), "rb"),
        caption="📤*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `DCManeger-Backup` was specially made for notes 📚.".format(
            chat.title, chat_id, tgl
        ),
        timeout=360,
    ...
    os.remove("DCManeger{}.backup".format(chat_id))  # Cleaning file
