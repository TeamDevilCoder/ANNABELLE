...
from DCManeger.modules.nightmode import button_row
from DCManeger import BOT_USERNAME, OWNER_ID,BOT_NAME, SUPPORT_CHAT, telethn
...
async def lego(event):
    ...
    try:
        ...
        fnt = glob.glob("./DCManeger/resources/fonts/*")
