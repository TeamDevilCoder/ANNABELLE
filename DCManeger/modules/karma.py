...
from DCManeger import OWNER_ID, pbot
from DCManeger.utils.admins import can_change_info
from DCManeger.utils.errors import capture_err
from DCManeger.utils.mongo import (
    alpha_to_int,
    get_karma,
    get_karmas,
    int_to_alpha,
...
regex_upvote =r"^(\+|\+\+|\+1|thx|thanx|thanks|🖤|❣️|💝|💖|💕|❤️|💘|cool|good|\👍|baby|dc|thank you|gud|thankyou|love|pro)$"
