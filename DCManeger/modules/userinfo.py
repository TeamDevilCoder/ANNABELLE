...
from DCManeger.modules.alive import Mukesh 
import DCManeger.modules.sql.userinfo_sql as sql
...
from DCManeger.__main__ import STATS, TOKEN, USER_INFO
from DCManeger.modules.disable import DisableAbleCommandHandler
from DCManeger.modules.helper_funcs.chat_status import sudo_plus
from DCManeger.modules.helper_funcs.extraction import extract_user
from DCManeger.modules.sql.global_bans_sql import is_user_gbanned
from DCManeger.modules.sql.users_sql import get_user_num_chats
...
def info(update: Update, context: CallbackContext):
    ...
    if disaster_level_present:
        text += ' \n[<a href="https://t.me/AMBOTYT/26">ᴄʟɪᴄᴋ ʜᴇʀᴇ ᴛᴏ ᴋɴᴏᴡ ᴡʜᴀᴛ ɪs ᴅɪsᴀsᴛᴇʀ ʟᴇᴠᴇʟs.</a>]'.format(
            bot.username
        )
