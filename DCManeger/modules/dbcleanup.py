...
import DCManeger.modules.sql.global_bans_sql as gban_sql
import DCManeger.modules.sql.users_sql as user_sql
from DCManeger import DEV_USERS, OWNER_ID, dispatcher
