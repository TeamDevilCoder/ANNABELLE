...
import DCManeger.modules.no_sql.users_db as user_db 
from DCManeger import pbot as dc
from DCManeger import DEV_USERS, LOGGER as  logger, OWNER_ID, dispatcher, DEVIL
from DCManeger.modules.helper_funcs.chat_status import dev_plus, sudo_plus
from DCManeger.modules.no_sql.users_db import get_all_users
...
@dev_plus
@dc.on_message(filters.command("bchat") & filters.user(DEVIL) & filters.reply)
...
@dev_plus
# broadcast
@dc.on_message(filters.command("buser") & filters.user(DEVIL) & filters.reply)
async def broadcast_handler(bot: Client, m: Message):
