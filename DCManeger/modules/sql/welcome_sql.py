...
from DCManeger.modules.helper_funcs.msg_types import Types
...
DEFAULT_GOODBYE_MESSAGES = [
    ...
    "{first} Bring him the photo",
    "{first} Go outside!",
    "{first} Ask again later",
    "{first} Think for yourself",
    "{first} Question authority",
    "You are worshiping a sun god {first}",
    "Don't leave the house today {first}",
    "Give up! {first}",
    "Marry and reproduce {first}",
    "{first} Stay asleep",
    "{first} Wake up",
    "Look to la luna {first}",
    "Steven lives {first}",
    "Meet strangers without prejudice {first}",
    "{first} A hanged man will bring you no luck today",
    "{first} What do you want to do today?",
    "You are dark inside {first}",
    "Have you seen the exit? {first}",
    "Get a baby pet it will cheer you up. {first}",
    "{first} Your princess is in another castle.",
    "{first} You are playing it wrong give me the controller",
    "{first} Trust good people",
    "{first} Live to die.",
    "When life gives you lemons reroll! {first}",
    "Well, that was worthless{first} ",
    "{first} I fell asleep!",
    "{first} May your troubles be many {first}",
    "{first} Your old life lies in ruin",
    "{first} Always look on the bright side",
    "{first} It is dangerous to go alone",
    "{first} You will never be forgiven",
    "You have nobody to blame but yourself {first}",
    "Only a sinner {first}",
    "Use bombs wisely {first}",
    "Nobody knows the troubles you have seen {first}",
    "You look fat you should exercise more {first}",
    "{first} Follow the zebra",
    "{first} Why so blue?",
    "{first} The devil in disguise",
    "{first} Go outside",
    "{first} Always your head in the clouds",
]
