...
@dc.on_message(filters.command(["short"]))
...
@dc.on_message(filters.command(["unshort"]))
...
# dc.add_handler(MessageHandler(short_urls))
# dc.add_handler(MessageHandler(unshort))
__help__ = """
ᴍᴀᴋᴇ sʜᴏʀᴛs ᴏғ ᴀ ɢɪᴠᴇɴ ʟɪɴᴋ 
 ❍ /short <url>  *:Example `/short https://t.me/AMBOTYT`.
 *"""
