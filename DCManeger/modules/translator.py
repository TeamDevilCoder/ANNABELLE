...
from DCManeger import DEVIL, dispatcher
from DCManeger import pbot as client

dc = "https://te.legra.ph/file/1a72f3770dcb90ee8b3f7.jpg"
...
**» ᴍʏ ᴅᴇᴠᴇʟᴏᴘᴇʀ :** [ᴅᴇᴠᴇʟᴏᴘᴇʀ](tg://user?id={DEVIL})
**» ᴩʏᴛʜᴏɴ ᴠᴇʀsɪᴏɴ :** `{y()}`
**» ʟɪʙʀᴀʀʏ ᴠᴇʀsɪᴏɴ :** `{o}` 
**» ᴛᴇʟᴇᴛʜᴏɴ ᴠᴇʀsɪᴏɴ :** `{s}` 
**» ᴘʏʀᴏɢʀᴀᴍ ᴠᴇʀsɪᴏɴ :** `{z}`
