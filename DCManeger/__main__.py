...
import DCManeger.modules.no_sql.users_db as sql
from DCManeger import (
    BOT_NAME,
    BOT_USERNAME,
    LOGGER,
    OWNER_ID,
...
from DCManeger.modules import ALL_MODULES
from DCManeger.modules.helper_funcs.chat_status import is_user_admin
from DCManeger.modules.helper_funcs.misc import paginate_modules
...
buttons = [
    [
        InlineKeyboardButton(text="🏡", callback_data="dc_back"),
        InlineKeyboardButton(text="🛡️", callback_data="dc_"),
        InlineKeyboardButton(text="💳", callback_data="source_"),
        InlineKeyboardButton(text="🧑‍💻", url=f"tg://user?id={DEVIL}"),
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("DCManeger.modules." + module_name)
    ...
    if update.effective_chat.type == "private":
        if len(args) >= 1:
            ...
            x=update.effective_message.reply_sticker(
                "CAACAgQAAxkBAAEGbjllpZrDtM98J0bGi77B5P-HoOcwaAACLwwAAuqTAVKXwqXcqn7CKDQE")
            x.delete()
        ...
        if mod_match:
            ...
            query.message.edit_caption(text,
                ...
                reply_markup=InlineKeyboardMarkup(
                    [[InlineKeyboardButton(text="ʙᴀᴄᴋ", callback_data="help_back"),InlineKeyboardButton(text="sᴜᴘᴘᴏʀᴛ", callback_data="dc_support")]]
                ),
            )
...
def dc_about_callback(update: Update, context: CallbackContext):
    query = update.callback_query
    if query.data == "dc_":
        uptime = get_readable_time((time.time() - StartTime))
        ...
        InlineKeyboardButton(text="🖥️", callback_data="Main_help"),
                    ...
                    [
                        InlineKeyboardButton(
                            text="🚩sᴜᴩᴩᴏʀᴛ", callback_data="dc_support"
                        ),
                        InlineKeyboardButton(
                    ...
                    [
                        InlineKeyboardButton(
                            text="👨‍💻ᴅᴇᴠᴇʟᴏᴩᴇʀ", url=f"tg://user?id={DEVIL}"
                        ),
                        InlineKeyboardButton(
                            text="🥀sᴏᴜʀᴄᴇ",
        ...
        InlineKeyboardButton(text="🖥️", callback_data="Main_help"),
                    ...
                    [
                        ...
                        InlineKeyboardButton(
                            text="ᴜᴩᴅᴀᴛᴇs 🍷", url=f"https://t.me/{CHANNEL}"
                        ),
                    ],
                    [
                        InlineKeyboardButton(
                    ...
                    [
                        InlineKeyboardButton(text="◁", callback_data="dc_"),
                    ],
                ]
            ),
        )
    elif query.data == "dc_back":
        first_name = update.effective_user.first_name 
...
def DCManeger_Main_Callback(update: Update, context: CallbackContext):
    query = update.callback_query
...
""",
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    ...
                    [InlineKeyboardButton(text="• Hᴏᴍᴇ •", callback_data="dc_back")]
                ]
            ),
        )
...
◽️ /staff ɢɪᴠᴇs ᴛʜᴇ ᴄᴏᴍᴘʟᴇᴛᴇ Lɪsᴛ ᴏғ ɢʀᴏᴜᴘ Sᴛᴀғғ!.""",parse_mode=ParseMode.MARKDOWN,
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(text="• ʙᴀᴄᴋ •", callback_data="Main_help"),InlineKeyboardButton(text="• sᴜᴘᴘᴏʀᴛ •", callback_data="dc_support")
                    ]
                ]
            ),
            )
...
Yᴏᴜ ᴄᴀɴ ʜᴇʟᴘ ᴛʜᴇ ᴅᴇᴠᴇʟᴏᴘᴍᴇɴᴛ ᴡɪᴛʜ ᴅᴏɴᴀᴛɪᴏɴs""",parse_mode=ParseMode.MARKDOWN,
        ...
        InlineKeyboardButton(text="🖥️", callback_data="Main_help"),
                    ...
                    [
                        InlineKeyboardButton(text="• Dᴏɴᴀᴛᴇ •", url="https://t.me/New_AMBOT"),InlineKeyboardButton(text="• sᴜᴘᴘᴏʀᴛ •", callback_data="dc_support")
                    ]
                ]
            ),
            )  
...
*ʜᴇʀᴇ ɪs ᴍʏ sᴏᴜʀᴄᴇ ᴄᴏᴅᴇ :* [ɢɪᴛʜᴜʙ](github.com/AbhiModszYT)
...
""",
            ...
            reply_markup=InlineKeyboardMarkup(
                [[
        InlineKeyboardButton(text="sᴏᴜʀᴄᴇ", url="github.com/AbhiModszYT")
                ],
                 [
        InlineKeyboardButton(text="🏡", callback_data="dc_back"),
        InlineKeyboardButton(text="🛡️", callback_data="dc_"),
...
""",
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(text=" ʙᴀᴄᴋ ", callback_data="Music_"),InlineKeyboardButton(text="sᴜᴘᴘᴏʀᴛ", callback_data="dc_support")
                    ]
                ]
            ),
        )
...
def get_help(update: Update, context: CallbackContext):
    ...
    if chat.type != chat.PRIVATE:
        ...
        send_help(
            ...
            text,
            InlineKeyboardMarkup(
                [[InlineKeyboardButton(text="◁", callback_data="help_back"),InlineKeyboardButton(text="sᴜᴘᴘᴏʀᴛ", callback_data="dc_support")]]
            ),
        )
...
def donate(update: Update, context: CallbackContext):
    ...
    if chat.type == "private":
        ...
        if OWNER_ID != 5360305806:
            update.effective_message.reply_text(
                f"» ᴛʜᴇ ᴅᴇᴠᴇʟᴏᴩᴇʀ ᴏғ {dispatcher.bot.first_name} sᴏᴜʀᴄᴇ ᴄᴏᴅᴇ ɪs [ɢɪᴛʜᴜʙ](https://github.com/AbhiModszYT)"
...
""",reply_markup=x,
            ...
            LOGGER.warning(
                f"Bot isn't able to send message to @DC_BOT_Support, go and check!"
            )
    ...
    about_callback_handler = CallbackQueryHandler(
        dc_about_callback, pattern=r"dc_", run_async=True
    )
    ...
    DCManeger_main_handler = CallbackQueryHandler(
        DCManeger_Main_Callback, pattern=r".*_help",run_async=True)
    ...
    dispatcher.add_handler(DCManeger_main_handler)
